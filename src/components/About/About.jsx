...
const About = () => {
  return (
    <div className="w-9/12 mx-auto my-10">
      <h1 className="text-[42px] font-[500] text-[#333333]">Giới thiệu</h1>
      <div className="flex mt-10 ">
        <div className="w-1/2 pr-50">
          <p className="text-[15px] text-[#4A4A4A] tracking-widest mb-10">
          ...
          <p className="text-[15px] text-[#4A4A4A] tracking-widest">
      ...
      <button className="px-10 py-3 rounded-[24px] border-solid border-2 border-black hover:scale-105 transition-all ease-linear">
        CHI TIẾT
      </button>
    </div>
  );
