        ...
        <Wrapper>
            ...
            <Bottom>
                <Info>
                    ...
                    {carts?.map((cart,index)=><Fragment key={index}>
                        <Product >
                        <ProductDetail>
                        ...
                        <PriceDetail>
                            <ProductAmountContainer>
                                ...
                                <Button onClick={()=>handleDeleteCart(cart._id)}>Delete
                                <Delete/>
                                </Button>
                            </ProductAmountContainer>
                ...
                <Summary>
                    ...
                    <Button style={{backgroundColor:`${total === 0 ? '#ccc' : '#fda401'}`,cursor:`${total===0 ? 'not-allowed':"pointer"}`}}>CHECKOUT</Button>
                </Summary>
            </Bottom>
        </Wrapper>
        <Footer/>
