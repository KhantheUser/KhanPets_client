...
width: 100vw;
height: 100vh;
background:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url('https://toiyeumeo.com/wp-content/uploads/2021/03/hinh-anh-meo-xinh-ngo-nghinh.jpg');
display: flex;
...
function Register() {
 ...
 phone : yup.string().required('Must have required field').matches(regexPhoneNumber,'Sai định dạng'),
    ...
    <Container>
        <Wrapper>
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <InputContainer>
                <Input  name='phone' {...register("phone")} placeholder='Phone number'/>
                
                <Error>{errors.phone?.message}</Error>
                </InputContainer>
                <InputContainer>
                
                <Input type={'date'} name='birth' {...register("birth")}  placeholder='Date of birth'/>
                ...
                <InputContainer>
                <Input type='password'  {...register("passwordConfirm")} placeholder='Confirm password'/>
